...
public class AppConverter {
    ...
    public AppListResponse convertToAppListResponse(List<AppModel> appBeans) {
    ...
    public AppCreateResponse convertToAppCreateResponse(AppModel appBean) {
        Asserts.isNotNull(appBean, "appBean is null");
        return new AppCreateResponse().setApp(buildAppDto(appBean));
    }

    private AppDto buildAppDto(AppModel appBean) {
        return new AppDto()
